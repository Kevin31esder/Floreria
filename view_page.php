...
if(isset($_POST['add_to_wishlist'])){
    ...
    if(mysqli_num_rows($check_wishlist_numbers) > 0){
        ...
        mysqli_query($conn, "INSERT INTO `wishlist`(user_id, pid, nombre, precio, imageb) VALUES('$user_id', '$product_id', '$product_name', '$product_price', '$product_image')") or die('query failed');
...
<section class="quick-view">
    ...
    <?php  
        if(isset($_GET['pid'])){
            $pid = $_GET['pid'];
            $select_products = mysqli_query($conn, "SELECT * FROM `productos` WHERE id = '$pid'") or die('query failed');
    ...
    <form action="" method="POST">
         ...
         <input type="submit" value="anadir a  wishlist" name="add_to_wishlist" class="option-btn">
