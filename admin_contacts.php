...
if(isset($_GET['delete'])){
   ...
   mysqli_query($conn, "DELETE FROM `mensage` WHERE id = '$delete_id'") or die('query failed');
...
<section class="messages">
   ...
   <div class="box-container">
      ...
      <?php
       $select_message = mysqli_query($conn, "SELECT * FROM `mensaje`") or die('query failed');
       if(mysqli_num_rows($select_message) > 0){
          while($fetch_message = mysqli_fetch_assoc($select_message)){
      ?>
      <div class="box">
         <p>Usuario id : <span><?php echo $fetch_message['user_id']; ?></span> </p>
