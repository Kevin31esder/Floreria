...
if(isset($_POST['add_to_wishlist'])){
   ...
   if(mysqli_num_rows($check_wishlist_numbers) > 0){
       $message[] = 'Producot ya en  wishlist';
       ...
       $message[] = 'Producto añadido a wishlist';
   }
...
if(isset($_POST['add_to_cart'])){
   ...
   if(mysqli_num_rows($check_cart_numbers) > 0){
       ...
       mysqli_query($conn, "INSERT INTO `carro`(user_id, pid, nombre, precio, cantidad, imagen) VALUES('$user_id', '$product_id', '$product_name', '$product_price', '$product_quantity', '$product_image')") or die('query failed');
...
<section class="products">
   ...
   <div class="box-container">
      ...
      <?php
         $select_products = mysqli_query($conn, "SELECT * FROM `productos` LIMIT 6") or die('query failed');
